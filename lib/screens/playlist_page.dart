...
import 'package:soundwave/utilities/song_filtering.dart';
import 'package:soundwave/utilities/sort_utils.dart';
import 'package:soundwave/widgets/edit_playlist_dialog.dart';
...
import 'package:soundwave/widgets/playlist_page/search_bar_section.dart';
import 'package:soundwave/widgets/song_bar.dart';
import 'package:soundwave/widgets/sort_chips.dart';
          ...
          Row(
            ...
            children: [
              if (widget.playlistId != null &&
                  !isUserCreated &&
                  !offlineMode.value &&
                  _resolvedPlaylistId != 'recommended')
                PlaylistLikeButton(
    ...
    return IconButton.filledTonal(
      ...
      onPressed: () async {
        try {
          ...
          final url = 'soundwave://playlist/custom/$encodedPlaylist';
