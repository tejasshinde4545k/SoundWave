...
import 'package:soundwave/widgets/auto_format_text.dart';

const String checkUrl =
    'https://raw.githubusercontent.com/bablu/soundwave/update/check.json';
const String releasesUrl =
    'https://api.github.com/repos/bablu/soundwave/releases/latest';
const String downloadUrlKey = 'url';
const String downloadUrlArm64Key = 'arm64url';
const String downloadFilename = 'SoundWave.apk';
