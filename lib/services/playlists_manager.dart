...
import 'package:soundwave/database/playlists.db.dart';
...
Future<Map?> getPlaylistInfoForWidget(
  ...
  if (normalizedId == 'recommended') {
    ...
    return {
      'ytid': 'recommended',
      'title': artistName ?? 'Recommended for you',
      'source': 'recommended',
      'image': artistImage ?? (songs.isNotEmpty ? songs.first['image'] : null),
      'list': songs,
    };
  }
  if (isArtist) {
