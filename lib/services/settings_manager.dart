...
final musicRegionSetting = ValueNotifier<String>(
  Hive.box('settings').get('musicRegion', defaultValue: 'auto') as String,
);
...
void reloadSettingsFromStorage() {
  ...
  musicRegionSetting.value =
      settings.get('musicRegion', defaultValue: 'auto') as String;
